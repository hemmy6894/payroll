...
class LoanModel extends Model
{
    ...
    public function activities(){
        return $this->hasMany(LoanActivitiesModel::class,'loan_id','id');
    }
    ...
    public function scopePayloan($query,$user_id,$comment=""){
        return ModelHelper::payloan($query,$user_id,"loan",$comment);
    }

    public function scopeCreateLoan($query,$user_id,$amount,$monthly_pay,$start_at,$rate = 0,$comment=""){
        return ModelHelper::createloan($query,$user_id,$amount,$monthly_pay,$start_at,"loan",$rate,$comment);
    }
